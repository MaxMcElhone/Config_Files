...
settings_table = {
    ...
    {
        name="execi 100 sensors | grep 'SMBUSMASTER 0'|awk '{print $3}'| cut -c2-3",
        arg='',
        max=110,
        bg_colour=0x000000,
        bg_alpha=0.8,
    ...
    {
        name='execi 1000 nvidia-settings -q gpucoretemp -t',
        arg='',
        max=100,
        bg_colour=0x000000,
        bg_alpha=0.8,
    ...
    {
        name="execi 1000 nvidia-smi -q -d memory | grep 'Used' | head -1 | awk '{print $3}'",
        arg='',
        max=6075,
        bg_colour=0x000000,
        bg_alpha=0.6,
...
function temp_watch()
    ...
    temperature=tonumber(conky_parse("${execi 100 sensors | grep 'SMBUSMASTER 0'|awk '{print $3}'| cut -c2-3}"))
...
function iface_watch()
    ...
    iface=conky_parse("${if_existing /proc/net/route enp33s0}enp33s0${else}wlan0${endif}")
